...
1. **M12** — Mac runner chat UI parity to X13 (Mac chat surface lacks structured-failure surfacing)
2. **C1** — Large-model chat stall investigation (qwen3:14b stalls; cross-OS; partly depends on M12)
