...
public sealed class RunnerLocalApiService : IRunnerLocalApiService
{
        ...
        CancellationToken ct)
    {
        ...
        {
            return ParsedAudioUpload.Fail("Malformed multipart upload.");
        }
        ...
        {
            return ParsedAudioUpload.Fail("Failed to read uploaded audio.");
        }
        catch (OperationCanceledException) when (ct.IsCancellationRequested)
        {
            return ParsedAudioUpload.Fail("Upload was canceled.");
        }
    }
